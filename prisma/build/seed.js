...
function generateDepartures(dayType, direction, rows) {
    ...
    return Object.entries(rows).flatMap(([hourStr, entries]) => {
        ...
        return entries.map(([mm, mark]) => {
            var _a, _b, _c;
            const isExpress = (_a = mark === null || mark === void 0 ? void 0 : mark.startsWith("*")) !== null && _a !== void 0 ? _a : false;
            const key = (_b = mark === null || mark === void 0 ? void 0 : mark.replace("*", "")) !== null && _b !== void 0 ? _b : "";
            return {
                direction,
                dayType,
                departureTime: `${hh}:${mm}`,
                destination: key ? (_c = mapDest[key]) !== null && _c !== void 0 ? _c : defaultDest : defaultDest,

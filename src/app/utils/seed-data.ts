import { Direction, DayType, Prisma } from "@prisma/client";

type Entry = [mm: string, mark?: string];

// シードデータ生成関数
export async function generateDepartures(): Promise<
...
> {
  ...
  // データを生成
  const seedData = [
    ...generateDepartureData("WEEKDAY", "UP", upWeekday),
    ...generateDepartureData("HOLIDAY", "UP", upHoliday),
    ...generateDepartureData("WEEKDAY", "DOWN", downWeekday),
    ...generateDepartureData("HOLIDAY", "DOWN", downHoliday),
  ];
